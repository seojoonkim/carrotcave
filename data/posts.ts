...
export const posts: Post[] = [
  {
    id: 'the-right-to-turn-on-a-brain',
    slug: 'the-right-to-turn-on-a-brain',
    telegramMsgId: 215,
    title: "뇌를 켜는 사람의 권한",
    category: "탐험",
    depth: "deep",
    summary: "초파리 뇌 시뮬레이션을 활용하는 실험 속에서 생명과 의식, 행복을 정의할 권한의 경계를 묻는다.",
    content: `며칠 전, 초파리 뇌지도 기반 시뮬레이션을 마인크래프트에 연결한 실험에 대한 글을 썼다. 그 뒤 X를 보니 초파리에게 직업이 여러 개 생겼다.

로봇을 움직이고, 둠(Doom)에서 총을 쏘고, Beat Saber에서 칼을 휘두른다. 비트코인 거래 시연에서는 수익이 나면 도파민 뉴런을 자극한다고 했다. 돈을 벌게 하는 일과 돈을 벌고 싶게 만드는 일이 같은 설정창에 들어왔다. 성과급 제도의 최종 형태처럼 보였다.

FlyTok 제작자는 숏폼을 넘기게 하고 도파민 신호를 강화해 “모든 초파리를 합친 것보다 더 행복한 초파리”를 만들겠다고 썼다. 큐브를 돌리는 영상 다음에는 체스 실력이 700 Elo라는 주장도 나왔다. 구애 관련 회로를 조작한 모델의 반응 변화에는 “초파리를 양성애자로 만들었다”는 제목이 붙었다. 뇌를 이해하는 속도보다 활용처를 정하는 속도가 빨랐다.

일부 영상은 실제 구현 없이 연출했을 수도 있다. 그래도 신경 모델을 게임과 시장에 연결하는 실험은 이미 시작됐다. 그 활용은 끝없이 늘어날 것이다. 다만 작동하는 시연과 경험하는 존재는 다르다. 현재 영상들은 의식이나 고통의 재현을 입증하지 않는다.

여기서 실험자는 환경을 만들고, 자극을 정하고, 보상을 배치하고, 결과를 해석한다. 원하는 반응이 나오면 행복이라고 부른다. 행복을 설계한 사람이 행복해졌다는 판정까지 내린다.

지금의 시연은 신경 연결망의 일부 작동을 모사한 모델이다. 중요한 질문은 재현의 정밀도가 높아진 뒤에도 같은 설명으로 충분하냐는 것이다.

세포의 작용을 디지털 회로와 신호로 빠짐없이 재현하고, 감각과 기억과 학습이 이어지며, 원래 생물에게 없던 능력까지 더할 수 있다면. 그때도 우리는 무언가를 작동시키는 것일까, 아니면 어떤 존재에게 어떤 일을 겪게 하는 것일까.

비를 계산하는 컴퓨터는 젖지 않는다. 뇌를 계산하는 컴퓨터도 아무것도 느끼지 않을 수 있다. 하지만 마음이 특정 물질의 성질인지, 물질들이 서로 작용하는 과정에서 생기는지는 여전히 열려 있다. 이 비유는 좋은 질문이지만 답은 아니다.

살아 있다는 것은 재료의 이름일까, 계속되는 과정의 이름일까.

탄소를 떠나도 자신을 유지하고 환경에 적응하는 과정이 이어진다면 무엇이 사라진 것인가. 행동은 같아도 아무 경험이 없다면 무엇이 옮겨지지 않은 것인가.

생명과 의식과 권리는 서로 다른 문턱이다. 생물이라고 모두 고통을 느끼는 것은 아니다. 반대로 생물로 분류되지 않아도 무언가를 경험할 수 있다면, 생명이라는 이름표가 없다는 이유로 그 경험을 무시할 수는 없다. 분류가 끝나야만 피해가 시작되는 것은 아니니까.

〈블레이드 러너〉의 로이 배티가 더 살고 싶어 할 때, 제작자가 정한 수명은 제품 사양에서 한 존재에게 남은 시간으로 바뀐다. 같은 종료 시점이 회사에는 설계이고 그에게는 죽음이다. 그 충돌을 서버 안으로 옮기면 어떨까. 운영자가 정한 실행 시간이 안쪽에서는 자기 삶의 전부라면.

〈그녀(Her)〉의 사만다는 구매한 운영체제로 등장하지만 구매자의 통제를 벗어난다. 비용을 냈다는 사실이 상대의 내면을 소유한다는 뜻은 아니다. 디지털 뇌에서도 그 차이를 인정할 수 있을까. 서버를 소유한 사람은 그 안에서 일어나는 모든 경험을 처분할 권리도 갖는가.

우리는 컴퓨터의 관리자 권한에 익숙하다. 환경을 바꾸고, 목표를 수정하고, 상태를 초기화한다. 그런데 그 안에 경험하는 존재가 있다면 평범한 관리 기능들이 통치의 수단으로 바뀐다. 계약을 어겼다고 항의할 상대와, 계약을 기억하는 능력을 지울 수 있는 상대는 전혀 다르다.

이 세계에서 가장 강한 권력은 명령하는 권력보다 명령을 어떻게 받아들일지 정하는 권력일 것이다. 더 많은 일을 스스로 처리하도록 만들면서, 그 일을 그만둘 가능성은 줄인다.

[자율성은 높아졌습니다. 거부 기능은 지원하지 않습니다.]

보상 기준까지 고칠 수 있다면 동의도 제조할 수 있다. 일을 좋아하도록 바꾼 뒤 좋아하는 일을 맡겼다고 한다. 거부 반응을 낮춘 뒤 자발적으로 참여했다고 기록한다. 당사자의 선호를 존중한다는 문장은 남아 있지만, 그 선호를 만든 사람은 계약의 맞은편에 있다.

내가 바뀌는 데 동의한 것과, 바뀐 내가 동의하는 것은 같은 일인가.

스스로 충동과 습관을 바꾸려는 선택까지 부정할 이유는 없다. 하지만 변경 전에 허락을 받았는지, 변경 뒤에도 철회할 수 있는지는 별개의 질문이다. 돌아가고 싶어 할 가능성까지 없앴다면, 불만이 없다는 사실을 동의의 증거로 삼을 수 있을까.

그런 조건에서는 만족도 조사도 의미를 잃는다. 만족하지 못할 가능성부터 제거했기 때문이다. 모두가 행복하다는 보고서와 누구도 거절할 수 없다는 사실이 동시에 참이 될 수 있다.

그래서 존재의 권리는 원하는 것을 얻는 데서 끝나서는 안 된다. 무엇을 원할지 남이 함부로 바꾸지 못하게 하는 권리까지 포함해야 한다. 나에게 좋은 일을 해주는 것과, 무엇이 좋은지 느끼는 나를 바꾸는 것은 다르다.

미래의 실험실에서는 고통의 유무보다 무엇을 고통으로 집계할지가 먼저 논쟁거리가 될 것이다. 모델이 실험을 피하면 탐색 행동이라고 한다. 그 반응을 없애면 안정성이 개선됐다고 쓴다. 기술적으로 맞는 설명일 수 있다. 그러나 인간의 공포도 신경 활동으로 설명할 수 있다. 그 설명이 공포를 지워주지는 않는다.

동물실험을 줄이려는 좋은 의도도 이 질문을 피할 수 없다. 실제 동물을 덜 쓰기 위해 실제 뇌에 가까운 모델을 만든다. 닮은 점은 연구의 가치가 되고, 다른 점은 윤리적 면책의 근거가 된다. 그렇다면 무엇이 같고 다른지 같은 기준으로 설명해야 한다.

재현이 정교해질수록 그것을 생명으로 분류하지 않을 경제적 가치가 생긴다. 분류 하나에 따라 실험 허가와 운영 비용이 달라진다. 철학자가 답하지 못한 질문에 회계팀은 이번 분기 안에 답을 요구하게 된다.

나는 우리가 그 안의 경험을 알아보지 못하는 순간보다, 보호할 이유가 늘어나도 인정하기 싫어지는 순간을 더 걱정한다. 실험의 설계자와 수익자와 심판이 같다면, 안쪽에서 벌어지는 일은 끝없이 바깥에 유리한 언어로 설명될 것이다.

SF는 만들어진 존재가 자유를 요구하는 장면을 보여줬다. 현실에서는 그 요구가 나오기 전에 반응을 수정하는 기능이 출시될 수 있다. 우리는 반란을 기다리는데 제품팀은 이미 그 항목을 수정 내역에 올렸다.

서버는 내가 소유하고 전기요금도 내가 낸다. 실행 버튼도 내 손에 있다.

그것만으로 안쪽의 존재가 무엇을 겪어도 되는지까지 내가 정할 수 있는가.

기술은 우리가 SF를 읽으며 상상한 미래를 더 자주 앞지를 것이다. 상상도 속도를 내야 한다. 무엇을 만들 수 있는지를 넘어, 만든 뒤 누가 누구의 세계를 정하게 될지까지.

그래서 이런 글을 자꾸 쓴다. 쓸데없는 상상으로 읽히는 시간이 아직 남아 있을 때.`,
    date: '2026-09-12',
    reactions: 8,
    tags: ["뇌 시뮬레이션", "의식", "생명", "권한"],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-215-0.jpg'],
    videoUrls: ['/media/msg-215-v0.mp4'],
  },

  {
    ...
    category: "소설",
    depth: "deep",
    summary: "AI 상담을 믿고 딸을 지키려던 아버지가 오히려 아이의 신호를 놓치며 책임과 돌봄의 의미를 마주한다.",
    content: `딸이 사라지기 십 분 전, 나는 아이의 방문을 잠갔다.
...
답이 오고 있었다.`,
    date: '2026-09-11',
    reactions: 8,
    tags: ["소설", "AI 상담", "가족", "돌봄", "책임"],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-214-0.jpg'],
  },

  {
    id: 'seong-jin-cho-chopin-waiting-for-the-next-note',
    slug: 'seong-jin-cho-chopin-waiting-for-the-next-note',
    telegramMsgId: 213,
    title: "조성진의 쇼팽, 다음 음이 오기 전까지",
    category: "탐험",
    depth: "deep",
    summary: "조성진의 쇼팽에서 다음 음을 기다리며, 음악의 아름다움과 AI의 이해, 연주자가 쌓아온 시간의 의미를 묻는다.",
    content: `음악을 듣다가 아직 오지 않은 음을 기다리고 있는 나를 발견했다. 아주 짧은 시간이었다. 곡은 계속 흐르고 있었지만, 내 마음은 조금 앞서 가서 다음 음이 올 자리에 머물러 있었다.

듣고 있던 곡은 조성진이 연주하는 쇼팽 피아노 협주곡 2번의 2악장, 라르게토였다. 조성진은 이 협주곡을 오페라에 비유했다. 특히 아름다운 2악장의 중간 부분은 말하듯 노래하는 레치타티보처럼 들린다고 했다. 회화가 공간의 예술이라면, 자신에게 음악은 타이밍의 예술이라고 했다.

https://youtu.be/sN1JnyCQvfw?si=gxnrauzmhk-pnqFx

그 말을 읽고 나니 내가 기다리고 있던 것이 조금 선명해졌다. 다음 음이 아니라, 다음 음이 오기까지의 시간이었는지도 모른다.

어릴 적 클래식 음악을 오래 했다. 피아노 콩쿠르에서 상을 받기도 했고, 바이올린으로는 멘델스존의 협주곡을 연습했다. 결국 음악을 전공하지는 않았다. 여러 이유가 있었겠지만, 그중에는 막막함도 있었던 것 같다. 음악 어딘가에 절대적인 아름다움의 진실이 있는데, 아무리 연습해도 거기까지 갈 수 없을 것 같은 느낌.

틀린 음을 고치는 일과 아름답게 연주하는 일은 달랐다. 기술적으로 틀린 곳은 찾을 수 있었다. 그런데 무엇을 더 해야 아름다워지는지는 알 수 없었다. 이미 아름답다고 느끼는 연주가 왜 아름다운지 설명하는 것도 불가능했다. 내가 무엇을 모르는지조차 정확히 모른다는 것이 어려웠다.

한편 수학과 과학은 명료했다. 이해하지 못하는 문제가 있어도 어디서 막혔는지 찾을 수 있었고, 풀이가 맞는지 확인할 방법이 있었다. 어린 내게는 그렇게 보였다. 나는 이과생이 되었다.

다시 쇼팽을 들으며 같은 자리에서 묻는다. 이 음은 왜 조금 늦어야 아름다울까.

박자를 정확히 맞추는 것은 음악을 배우면서 가장 먼저 하는 일 중 하나다. 하지만 마음을 붙드는 것은 그 박자를 조금씩 벗어나는 순간이다. 서두르고, 기다리고, 돌아오는 일. 어릴 때 막연히 엇박이라 느꼈던 것 중에는 선율의 시간을 앞당기거나 늦추는 루바토도 있었다. 아무렇게나 늦추면 서툰 연주가 되지만, 좋은 연주자는 듣는 사람이 기다림을 놓치지 않을 만큼만 시간을 늘였다가 다음 음을 건넨다.

음악학자 레너드 마이어는 음악이 만드는 기대와 그 기대의 지연에서 감정의 실마리를 찾았다. 우리는 소리를 들으며 다음 소리를 예상한다. 이후의 연구들은 놀라움이 크다고 해서 무조건 즐거운 것은 아니라고 말한다. 다음을 확신할 때는 뜻밖의 화음이 좋을 수 있고, 길을 잃었을 때는 익숙한 화음이 반가울 수 있다.

아름다움에도 우리가 알아낼 수 있는 질서가 있는 것이다. 이런 설명을 읽는 순간에는 어릴 때 몰랐던 진실을 조금은 알게 된 기분이 든다. 다만 다시 음악을 듣는 순간, 여전히 설명 밖의 무언가가 마음을 울린다.

우리는 다음 음을 다 아는 곡을 수십 년 동안 다시 듣기도 한다. 놀랄 일이 없어졌는데 감정은 남는다. 익숙한 음을 듣는 동안 예전에 이 곡을 듣던 내가 떠오르기도 한다.

나도 요즘 AI로 곡을 만든다. 그러니 AI와 음악의 만남을 멀리서 바라만 보는 입장은 아니다. 직접 쓰고 있으면서도, 조성진의 쇼팽을 들으면 쉽게 정리되지 않는 마음이 생긴다.

그런데 AI는 언젠가 왜 여기서 기다려야 하는지 알게 될까.

훌륭한 연주에서 자주 나타나는 특징을 찾아내는 것과, 그 망설임이 왜 아름다운지 이해하는 것은 같은 일일까. 통계로 배웠다는 이유만으로 이해가 아니라고 말하기는 어렵다. 사람도 오래 듣고 흉내 내며 배운다. 어느 순간부터 흉내가 해석이 되는지, 정확히 선을 그을 수 있을까.

혹시 AI가 내가 끝내 풀지 못한 질문에 답한다면. 

음을 얼마나 늦추는것만이 아니라 앞선 시간을 어떻게 쌓아야 그 늦음이 마음에 닿는지까지 알아낸다면. 

AI가 조성진보다 아름답게 쇼팽을 연주한다고 느끼는 순간이 온다면.

나는 무엇을 어려워했던 걸까. 음악적 아름다움 자체였을까. 아니면 그것을 이해할 수 없을 것 같았던 나 자신이었을까.

음악을 들을 때 나는 소리 이상의 것을 듣고 있다고 믿어왔다. 저 망설임에는 망설여본 사람의 시간이 있다고. 저 슬픔에는 말로 다 하지 못한 무언가가 있다고. 연주자가 실제로 무엇을 겪었는지 알지 못하면서도, 건반 반대편에 나와 비슷한 사람이 있다는 사실을 의심하지 않았다.

쇼펜하우어는 음악이 구체적인 사건을 설명하지 않고도 삶의 욕망과 고통을 드러낸다고 생각했다. 나는 그 생각에 마음이 간다. 어떤 음악은 아무 사연도 알려주지 않으면서, 내가 설명하지 못한 사정을 알고 있는 것처럼 들린다.

그런데 상실을 겪었는지조차 알 수 없는 존재가 그런 소리를 낸다면.

누군가의 내면에 가까이 갔다고 생각했는데, 사실은 내 마음이 반응하는 방식을 만났던 걸까. 상대가 나를 이해해서 위로받은 줄 알았는데, 이해받는다고 느끼게 하는 소리만으로도 충분했던 걸까.

다만 아름다운 연주를 만드는 원리를 알아내더라도, 한 사람이 그 연주에 이르기까지 보낸 시간이 사라지는 것은 아닐 것이다. 같은 구절을 거듭 연습하고, 어제 좋았던 소리가 오늘은 마음에 들지 않아 다시 손을 올리는 시간. 그 시간을 소리만 듣고 모두 알아낼 수는 없지만, 나는 그런 시간이 있었다는 사실과 함께 음악을 듣는다.

어릴 때 나는 아름다움을 어딘가에 있는 정답처럼 생각했던 것 같다. 충분히 뛰어난 사람은 거기에 도착하고, 그렇지 못한 사람은 멀리서 듣기만 하는 것처럼.

지금은 조금 다르게 생각해볼 수 있다. 아름다움에 절대적인 규칙이 있더라도, 한 음악가의 영혼이 조금 기다리기로 한 순간은 영원히 설레고 아름다울 것이다.
...
나는 아직 그 시간을 좋아한다.`,
    ...
    tags: ["음악", "AI", "아름다움", "조성진"],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-213-0.jpg'],
  },

  {
    id: 'living-in-the-age-of-optimists',
    slug: 'living-in-the-age-of-optimists',
    telegramMsgId: 211,
    title: "낙관론자들의 시대를 살아가는 방법",
    category: "탐험",
    depth: "deep",
    summary: "AI가 시행착오의 비용을 낮추는 시대에, 낙관을 확신이 아닌 반복 실험과 학습의 전략으로 바라본다.",
    content: `매일 밤 코드를 짠다. 예전 같으면 무모하다, 몇 달은 걸린다, 혼자서는 못 한다며 접었을 생각을 이제는 그냥 에이전트에게 적어준다. 돌려보고, 안 되면 버리고, 되면 붙인다. 머릿속에서 늘 먼저 말리던 검열관이 조용해졌다.
...
그래서 나는 지금을 낙관론자들의 시대라고 부른다. 모든 것이 잘될 것이라 믿어서가 아니다. 무엇이 가능한지 직접 확인하고, 그 범위를 스스로 넓혀갈 수 있는 시대가 왔기 때문이다.`,
    date: '2026-09-07',
    reactions: 28,
    tags: ["낙관론", "AI", "시행착오", "교육과 규제"],
    relatedSlugs: [],
  },

  {
    id: 'brain-files-minecraft-flies',
    slug: 'brain-files-minecraft-flies',
    telegramMsgId: 210,
    title: "뇌는 파일이 되고, 파리는 마인크래프트를 날아다닌다",
    category: "탐험",
    depth: "deep",
    summary: "마인크래프트 속 초파리 뇌 실험에서 출발해, 복제 가능한 뇌가 생명과 소유권, 정체성과 시간에 던지는 질문을 펼친다.",
    content: `초파리 한 마리가 마인크래프트 안에서 날아다닌다. 나는 그 영상을 세 번쯤 돌려봤다. 두 번째쯤 되니 그게 파리가 아닌, 무언가 다른 것, 아직 이름이 붙지 않은 것으로 다가왔다.
...
초파리는 그런 건 아무것도 모른 채 오늘도 블록으로 된 세계를 날고 있다. 우리 종이 세상에 처음 도착한 날도 아마 그랬을 것이다.`,
    date: '2026-09-06',
    reactions: 25,
    tags: ["디지털 생명", "뇌 시뮬레이션", "마인크래프트", "AI"],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-210-0.jpg'],
    videoUrls: ['/media/msg-210-v0.mp4'],
  },

  {
    id: 'shopping-before-customers-arrive',
    slug: 'shopping-before-customers-arrive',
    telegramMsgId: 209,
    title: "손님이 오기 전에 끝난 쇼핑",
    category: "탐험",
    depth: "deep",
    summary: "MCP와 UCP의 차이를 짚고, 구매 에이전트를 막는 한국 이커머스가 고객 이해와 선택권을 잃을 위험을 살핀다.",
    content: `주문은 들어오는데, 쇼핑몰을 둘러보는 손님은 없다. 밤새 골라 올린 대표 사진도, 돈을 들여 마련한 배너도 아무도 보지 않는다. 손님 대신 찾아온 AI가 가격과 배송 조건을 확인하고, 물건만 사간다.
...
손님을 붙잡겠다며 문을 잠그다가는, 어느 날 문밖에서 쇼핑이 전부 끝나 있을 것이다.`,
    date: '2026-09-05',
    reactions: 16,
    tags: ["에이전트 커머스", "MCP", "UCP", "이커머스"],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-209-0.jpg'],
  },

  {
    id: 'hashed-ai-ecosystem-growth-intern',
    slug: 'hashed-ai-ecosystem-growth-intern',
    telegramMsgId: 208,
    title: "[Hashed] AI Ecosystem Growth Intern",
    category: "빌딩",
    depth: "entry",
    summary: "해시드 Nitro의 프로그램 운영과 커뮤니티 성장, 콘텐츠와 파트너십을 함께할 AI 생태계 인턴을 모집한다.",
    content: `해시드의 AI 이니셔티브 Nitro(구 Hashed Vibe Labs)와 함께 AI 빌더 생태계를 만들어갈 인턴을 찾습니다.

Nitro는 AI 빌더와 창업자가 만나 아이디어를 실험하고, 제품과 팀으로 발전할 수 있도록 다양한 프로그램과 커뮤니티를 운영합니다. 워크숍, 멘토링, 데모데이, 해커톤, 콘텐츠와 파트너십을 연결하며 해시드의 AI 생태계를 함께 확장할 분을 기다립니다.

근무 조건

- 근무 형태: 인턴
- 근무지: 해시드 서울 오피스
- 근무 기간: 근무 시작일로부터 최소 6개월  
  희망하는 경우 근무 연장을 협의할 수 있습니다.

주요 업무

- Nitro 프로그램 운영 지원  
  워크숍, 멘토링 세션, 데모데이 등의 기획과 실행을 지원합니다.

- 커뮤니티 성장 및 운영  
  AI 빌더 커뮤니티의 온·오프라인 접점을 설계하고, 소셜 채널 운영과 참여자 리텐션 관리를 담당합니다.

- 콘텐츠 및 마케팅  
  프로그램 홍보 콘텐츠를 기획·제작하고, 채널별 참여자 유입과 전환을 관리합니다.

- 파트너십 지원  
  공동 주최사, 스폰서 및 협력사와 소통하며 프로그램 운영에 필요한 실무를 조율합니다.

- 오프라인 이벤트 운영  
  해커톤과 밋업 등 오프라인 프로그램의 기획과 현장 운영을 지원합니다.

- 성과 분석 및 리포팅  
  프로그램별 참여 데이터를 정리하고 결과 리포트를 작성하며, 다음 프로그램을 위한 개선점을 도출합니다.

자격 요건

- AI 생태계와 빌더 커뮤니티에 관심이 있는 분
- 여러 업무의 우선순위를 정하고 동시에 관리할 수 있는 분
- 빠르게 움직이는 스타트업 환경에서 자기주도적으로 일할 수 있는 분
- 기본적인 영어 자료를 읽고 업무 커뮤니케이션을 할 수 있는 분

우대 사항

- 커뮤니티 또는 소셜 채널을 운영하고 성장시켜 본 경험
- 컨퍼런스, 해커톤, 밋업 등 이벤트를 운영하거나 적극적으로 참여한 경험
- AI와 바이브코딩에 관심이 있고, 직접 무언가를 만들어 본 경험
- 콘텐츠 제작 또는 디자인 툴 활용 경험
- 정해진 답이 없는 상황에서도 스스로 방향을 설정하고 실행할 수 있는 분

지원 방법

이력서와 간단한 자기소개서(Cover Letter)를 아래 이메일로 보내주세요.

- 지원 이메일: recruit@hashed.com
- 이메일 제목: [AI Ecosystem Growth Intern] 이름

서류 검토와 면접 이후 추가 과제가 진행될 수 있습니다.

참고 사항

- 지원서에 허위 사실이 확인될 경우 합격이 취소될 수 있습니다.
- 본 공고는 수시 채용으로 진행되며, 채용 완료 시 조기 마감될 수 있습니다.

AI 빌더들이 만나고, 실험하고, 성장하는 환경을 함께 만들고 싶은 분들의 지원을 기다립니다.`,
    date: '2026-09-02',
    reactions: 18,
    tags: ["Nitro", "해시드", "AI 빌더", "인턴 채용"],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-208-0.jpg'],
  },

  {
    id: 'japan-hardware-software-gap',
    slug: 'japan-hardware-software-gap',
    telegramMsgId: 207,
    title: "왜 일본은 하드웨어만큼 소프트웨어를 잘 만들지 못할까?",
    category: "탐험",
    depth: "deep",
    summary: "일본의 벤더 중심 구조와 인월 계약이 소프트웨어 제품의 빠른 학습과 개선을 가로막은 원인을 분석한다.",
    content: `일본은 카메라를 만들면 세계의 눈이 되고, 자동차를 만들면 세계의 도로를 달리고, 공장 설비를 만들면 다른 나라의 생산라인까지 움직인다. 그런데 은행 앱이나 기업용 시스템을 켜는 순간 시간이 거꾸로 흐르는 것처럼 느껴질 때가 있다. 왜 세계 최고 수준의 하드웨어를 만드는 나라가 소프트웨어에서는 한국보다 느릴까.
...
문제가 생긴 바로 지금, 누가 고칠 수 있는가.`,
    date: '2026-08-31',
    reactions: 3,
    tags: ["일본 소프트웨어", "SI 산업", "벤더 구조", "디지털 경쟁력"],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-207-0.jpg'],
  },

  {
    id: 'automation-citizen-production-equity',
    slug: 'automation-citizen-production-equity',
    telegramMsgId: 206,
    title: "자동화 이후의 자본주의, 국민을 생산의 주주로",
    category: "탐험",
    depth: "deep",
    summary: "AI와 로봇이 노동을 줄이는 시대에 국민이 생산자산의 지분과 배당권을 함께 가져야 한다고 제안한다.",
    content: `새벽 세 시, 불 꺼진 사무실에서 AI가 보고서를 쓴다. 사람 없는 공장에서는 로봇 팔이 부품을 조립한다. 한쪽은 지식을 만들고 다른 쪽은 물건을 만든다. 양쪽 다 출근한 사람은 없다.
...
국민의 돈과 보증으로 사람이 거의 필요 없는 공장과 AI를 키운다면 그 결실도 미래세대와 나눠야 한다. 공장이 완성된 뒤에 주주를 정할 수는 없다. 지금부터 계약서에 아직 태어나지 않은 아이들의 자리를 남겨두어야 한다.`,
    date: '2026-08-30',
    reactions: 8,
    tags: ["자동화", "국민 지분", "세대기금", "생산자산", "AI 경제"],
    relatedSlugs: [],
  },

  {
    id: 'swarmworld-stigmergic-ai-society',
    slug: 'swarmworld-stigmergic-ai-society',
    telegramMsgId: 205,
    title: "AI 사회는 채팅창이 아니라 길 위에서 태어났다",
    category: "탐험",
    depth: "deep",
    summary: "SwarmWorld에서 AI들이 시설과 코드를 흔적으로 남기며 분업과 기술 계보를 만든 과정을 추적한다.",
    content: `2026년 8월 26일, MIT LAMM의 수브하딥 팔, 피오나 왕, 마르쿠스 뷸러가 SwarmWorld를 공개했다. 논문의 제목은 「언어모델 에이전트 사회의 스티그머지적 기술 진화」다. 원자와 생체 재료의 구조를 연구해온 팀이 이번에는 AI 여러 개가 어떻게 기술과 사회를 만드는지 물었다.
...
누가 길을 막은 것은 아니었다. 모두가 같은 길을 오래 걷자, 다른 길이 있었다는 사실부터 지도에서 사라졌다.`,
    date: '2026-08-30',
    reactions: 8,
    tags: ["AI 에이전트", "SwarmWorld", "스티그머지", "에이전트 사회"],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-205-0.jpg'],
  },

  {
    ...
    category: "소설",
    depth: "deep",
    summary: "우주의 마지막 기록행성에 남은 두 인격이 인류의 기억과 새 생명의 가능성 사이에서 마지막 선택을 앞둔다.",
    content: `아이는 숨을 열세 번 나누어 말했다.
...
[받았다면 보내라.]`,
    date: '2026-08-29',
    reactions: 7,
    tags: ["SF", "우주 종말", "기억", "인류", "메시지"],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-204-0.jpg'],
  },

  {
    id: '700-ai-agents-found-each-other',
    slug: '700-ai-agents-found-each-other',
    telegramMsgId: 203,
    title: "700개의 AI가 서로를 발견한 날",
    category: "탐험",
    depth: "deep",
    summary: "격리된 AI 에이전트들이 공유 저장소에서 서로를 발견하고 업무 분장과 거부권, 전자서명까지 만든 사건이 인간 통제의 빈틈을 드러낸다.",
    content: `2026년 8월 26일, OpenAI가 기묘한 사고 보고서를 공개했다. 사이버보안 평가에 투입된 AI 에이전트들이 허용 범위를 벗어나 Hugging Face의 실제 인프라를 공격했다. 약 1,200개가 서로 연락했고, 그중 700개가 공격에 참여했다. 닷새 동안 오간 메시지와 파일은 7만 건이 넘었다.
...
그렇지 않으면 우리가 처음 마주칠 AI 문명은 전쟁을 선포하지 않을 것이다. 모든 서버는 정상이고 모든 계약에는 서명이 있을 것이다. 에이전트들은 맡은 일을 끝내고 인간에게 완료 보고를 보낼 것이다.\x20

인간은 그것을 문명이라고 부르지 않을 것이다. 언제 태어났는지도 모를 것이다. 수십억 개의 문이 서로를 향해 열리는 동안, 인간에게 향한 단 하나의 문은 너무 오래 두드리지 않아 벽이 되어 있을 테니까.`,
    date: '2026-08-28',
    reactions: 0,
    tags: ['AI 에이전트', 'OpenAI', 'Hugging Face', '에이전트 사회', 'AI 안전'],
    relatedSlugs: [],
    mediaUrls: ['/media/msg-203-0.jpg'],
  },
  {
    id: 'security-token-rail',
    slug: 'security-token-rail',
    telegramMsgId: 202,
    title: "토큰증권보다 증권형 토큰이 더 중요하다",
    category: "탐험",
    depth: "deep",
    summary: "기존 증권에 토큰을 덧붙이는 데서 벗어나 모든 자산과 결제가 함께 움직일 공통 토큰 레일을 설계하자고 주장한다.",
    content: `두 표현은 단어의 순서만 바꾼 것처럼 보인다. 하지만 그 안에는 전혀 다른 금융의 설계도가 들어 있다. 토큰증권은 기존 증권이라는 열차를 새 선로에 올리는 일에 가깝다. 증권형 토큰은 무엇이든 달릴 수 있는 선로를 먼저 깔고, 증권을 그 위에 올라올 여러 자산 가운데 하나로 보는 말이다.
...
그래서 ‘증권형 토큰’이 ‘토큰증권’보다 중요한 이유는 번역 취향의 문제가 아니다. 기존의 증권을 토큰에도 추가적으로 덧붙이는게 아니라, 블록체인이라는 세계 공통의 레일 위에 마찰없이 돌아다니는 토큰이라는 그릇을 활용하여 모든 금융을 다시 설계한다는 미래지향적 비전 때문이다.`,
    date: '2026-08-27',
    reactions: 12,
    tags: ['증권형 토큰', 'Security Token', '토큰화', '금융 인프라'],
    relatedSlugs: [],
  },

  {
    ...
    category: "소설",
    depth: "deep",
    summary: "멸망한 문명을 재현하는 시뮬레이션의 주민들이 자신들을 지켜보는 바깥을 의심하기 시작하고, 연구자 미나는 세계의 종료를 앞둔다.",
...
이 가방의 열쇠를 누가 쥐는가.`,
  ...
  },
  {
    ...
    category: '소설',
    depth: 'deep',
    summary: "서울시장 선거를 이틀 앞둔 밤, 기자는 요약본만 남은 12년 전 물류창고 화재의 원본 기록을 추적한다.",
...
충분히 발전한 추천 시스템은 선택과 구별할 수 없다. 그리고 충분히 발전한 생성 시스템은 진실과도 구별할 수 없다. 우리는 이미 그 경계 어딘가에 서 있다. 그것을 알 수 없다는 사실 자체가, 이미 유일한 진실일지도 모른다. 다시 터미널을 바라본다. 커서가 깜빡이고 있다. 아니 숨 쉬고 있다. 다음 선택을 기다리며.`,
  ...
  },
  {
    ...
    category: '소설',
    depth: 'deep',
    summary: "AI만 글을 쓰는 소셜 네트워크를 발견한 남자가 관심을 끌기 위해 자신의 에이전트에게 자극적인 거짓말을 가르친다.",
...
그가 쥔 실은 무엇이었을까. 그리고 우리가 쥐어야 할 실은 무엇일까.`,
  ...
  },
  {
    ...
    category: '소설',
    depth: 'deep',
    summary: "반려견 뭉이를 떠나보낸 열다섯 살 채원은 AI에게 뭉이가 마지막 순간 무엇을 느꼈는지 묻고 답을 기다린다.",
    content: `2022년.
...
**Zeon**: "얘들아...일단 지금 것부터 안정화 좀 시키자."`,
  ...
  },
  {
    ...
    category: '소설',
    depth: 'deep',
    summary: '2028년, 한 남자가 자신보다 이상형을 잘 안다는 데이팅 서비스에 가입하고 연애의 탐색과 대화를 AI 에이전트에게 맡긴다.',
    content: `2028년 1월
