...
test('iOS webviews extend the graphite header through the top safe area', () => {
  ...
  assert.match(stylesSource, /--cc-mobile-brand-row-height:57\.6px;--cc-mobile-axis-row-height:48\.6px/);
  assert.match(stylesSource, /\.cc-header:not\(\.cc-header--reading\)\{height:calc\(var\(--cc-mobile-brand-row-height\) \+ var\(--cc-safe-top\)\);[^}]*background:var\(--cc-header-surface\)/);
  assert.match(stylesSource, /\.cc-header:not\(\.cc-header--reading\) \.cc-header__inner\{[^}]*height:var\(--cc-mobile-brand-row-height\);[^}]*grid-template-rows:var\(--cc-mobile-brand-row-height\)/);
  assert.match(stylesSource, /\.cc-header-axis-mobile\{display:block;position:sticky;top:calc\(var\(--cc-mobile-brand-row-height\) \+ var\(--cc-safe-top\)\);[^}]*background:var\(--cc-header-surface\)/);
  assert.match(stylesSource, /@media\(max-width:900px\)\{[^\n]*\.cc-header:not\(\.cc-header--reading\) \.cc-header__axis--desktop\{display:none\}/);
  assert.match(stylesSource, /\.cc-header-axis-mobile \.axis-rail\{width:100%;height:var\(--cc-mobile-axis-row-height\);[^}]*background:var\(--cc-header-surface\)/);
  ...
  assert.match(stylesSource, /\.cc-header-axis-mobile \.axis-rail a\{[^}]*background:var\(--cc-header-surface\);/s);
  assert.match(stylesSource, /\.cc-header-axis-mobile::before\{[^}]*inset-block:0;[^}]*left:50%;[^}]*width:100vw;[^}]*background:var\(--cc-header-surface\);/s);
