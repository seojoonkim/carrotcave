...
🙏28❤13👾3👍2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "포르쉐 911 터보 S보다 출력이 두 배 센 차를 1억 원 안팎에 살 수 있다면, 어느 나라 차일까.\nBYD의 프리미엄 브랜드 덴자가 만든 Z다...",
...
❤12👍6`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "어느 날 아침, 지갑 앱이 나보다 먼저 일어나 있다.\n밤새 냉장고는 부족한 우유를 주문하고, 작업용 AI는 서버 사용료를 결제하고, 자동차는 충...",
...
❤22👍8`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "API 키가 아니라 여권을 확인하는 로그인 화면을 상상한다. Fable 5 차단의 핵심은 국적이었다. 결제도 되고, 회사 이메일도 있고, API...",
...
❤59👍13🤮3🙏2🤡1🖕1`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "Pokemondev.com Harness Hackathon은 6월 6일, Hashed가 운영하는 해커하우스 vyvhouse에서 열린 실험적 해커...",
...
vyvhouse에서 열린 이 해커톤은 귀여운 포켓몬 화면을 통해 아주 진지한 가능성을 보여줬다. 에이전트는 모든 것을 자동화할 수 있는가. 게임은 그 자동화를 받아들일 수 있는가. 봇은 언제나 적인가, 아니면 인증되고 통제된 조건 아래 새로운 게이머가 될 수 있는가. 답은 아직 완성되지 않았지만, 참가자들은 적어도 한 가지를 확인했다. 에이전트가 세계를 배우는 과정을 인간이 옆에서 지켜보고 훈수두는 일은, 생각보다 훨씬 재미있다.`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'entry',
    summary: "AI로 패러다임이 바뀌었습니다. 이제 좁은 시장 안에서 우리끼리 싸우는 건 의미가 없습니다. 글로벌과 경쟁하려면 힘을 합쳐 시장 크기부터 키워야...",
...
당장 돈이 되지 않더라도 해야 할 일입니다. 영리한 계산이 깔려있을지라도, 우리끼리 싸우지 말고 판을 키우자며 먼저 문을 열어젖히는 액션에는 분명히 리스펙트할 만한 진정성이 있습니다. 해시드의 제작 지원을 통해 함께 제작하였습니다. 이런 이벤트들이 더 많이 소개되고, 한국에 더 많아지길 기대하는 마음입니다.`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: "이제 \"AI가 코딩 잘한다\"는 말은 더 이상 자랑거리도 아니다. 그냥 사실이다. 정작 흥미로운 질문은 따로 있다. \"에이전트가 포켓몬을 깰 수...",
...
❤26`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: "https://www.youtube.com/watch?v=Wx0C42-S5z4\n존경하는 노정석 대표님과는 오래전부터 인연이 있었고, AI 프론티...",
...
❤16🔥1`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "얼마 전 한 개발 특성화고 졸업생과 이야기를 나누다 들은 말이 마음에 오래 남았다. 학생들 상당수가 프론티어 모델 구독 계정을 제대로 쓰지 못한...",
...
❤62👍12👾1`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: "글을 쓴다는 것은 생각을 정리하는 일이라고들 한다. 그러나 막상 쓰기 시작하는 순간, 나는 생각이 정리되지 않았다는 사실을 가장 강렬하게 발견한...",
...
❤48👍5`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "지난주 Nitro Seoul이 마무리되었다. 데모데이(우리는 게임데이라고 부른다) 무대도 비었고 박수도 가라앉았다. 그날 밤은 며칠이 지나도 모...",
...
❤38👌6👍5👾1`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: "​8주 전, 5팀이 같은 출발선에 섰습니다.\n​피치덱은 없었습니다. 프로덕트와 트랙션만으로 선발했고, 선발과 동시에 투자가 집행되었습니다. 자료...",
...
❤15🙏4👍2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "인류는 한 번도 꿈을 통제한 적이 없다. 잠들면 그곳에 끌려들어가고, 깨어나면 풍경의 99%를 잊는다. 하루의 3분의 1을 거기서 보내면서도,...",
...
❤16👍5🙏2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "다리오 아모데이가 2025년 5월 Axios 인터뷰에서 말했다. 그는 Anthropic의 CEO이자 그 기술의 위험을 가장 크게 외치는 사람이다...",
...
❤16👍7`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "얼마 전붙 GLM 시리즈를 만드는 중국 최대 AI 기업 지푸(Zhipu)의 API를 원활히 쓰려면, 아침 10시에 접속해야 한다. 가격을 83%...",
...
👍14🙏4❤3`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "매일 아침 매던 넥타이가 있다. 어느 날 거울 앞에 서서 묻는다. 이걸 왜 매고 있지?\nAtlassian, 52주 고점 대비 76% 증발. Sa...",
...
❤39👍16👾4`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "여의도가 잠든 새벽 두 시, 한국 시장은 다른 화면에서 돌고 있다. 증권사 앱은 닫혔지만, 위험은 닫히지 않았다. 누군가는 KR200의 방향성에...",
...
❤36👍13🔥3🙏1👾1`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: "요즘 AI 시장을 보면서 이상한 감각을 자주 느낀다. 프런티어 모델은 여전히 강하다. 그런데 그 강함을 바라보는 내 시선은 예전과 다르다. 성능...",
...
❤43👍18🙏4👾3👎1`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: "낮잠을 자고 일어나면 같은 사람인데 다른 사람이 된 것 같은 순간이 있다. 몸은 그대로인데 무거운 것들이 바닥으로 내려앉아 있고, 머릿속에는 아...",
...
❤38👍9🙏3👾1`,
...

  {
    ...
    category: '🛠️ 빌딩',
    depth: 'mid',
    summary: 'MelGeek의 EVA-00 레이 에디션 키보드 디자인과 성능을 소개합니다.',
    content: `MelGeek Evangelion Centauri 80 EVA-00 Rei Ayanami
...
❤9🙏3👍2👾1`,
...

  {
    ...
    category: '🛠️ 빌딩',
    depth: 'mid',
    summary: 'Codex와 Claude의 작업을 경쟁적으로 조정하는 오픈소스 프로젝트 소개.',
    content: `AI를 가스라이팅하는 오픈소스를 만들었다
...
❤44👍14😁4🔥2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: 'AI가 존재 사이의 이해를 어떻게 변화시킬 수 있는지에 대한 탐구.',
...
숲이 정말로 우리에게 말을 걸어오는 날이 온다면, 우리는 그제야 알게 될 것이다. 풍요의 끝에서 인간이 끝내 비싸게 매기는 것은 기능이 아니라 관계이고, 정보가 아니라 세계이며, 수명이 아니라 끝내 함께 남고 싶은 이야기라는 것을.`,
...

  {
    ...
    category: '🛠️ 빌딩',
    depth: 'entry',
    summary: 'Across Inc.에서 Executive Assistant 인턴을 채용하며 책 선물 이벤트도 진행합니다.',
    content: `인턴 채용 공고 + AEO/GEO 베스트셀러 책 선물 이벤트
...
❤17🙏2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: 'AI와 글쓰기의 변화 속에서 개인의 판단과 기억의 중요성을 탐구한다.',
    content: `편차가 희소해지는 세계를 건너는 법
...
❤30👍8🔥4👎2🙏1`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '프롬프팅 역량이 AI 시대의 새로운 생산성 지표로 떠오르고 있다.',
    content: `프롬프팅 역량이 인류의 새로운 전투력이 되는 날
...
❤40👍12`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: 'K-POP 팬덤의 블록체인 활용과 디지털 의사결정 구조에 대한 분석.',
    content: `K-POP 팬덤은 어떻게 디지털 의회가 되었나
...
❤25👍7`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '대학의 가치와 역할 변화에 대한 심도 있는 분석.',
    content: `정류장에 세우기 전에
...
❤41👍16🔥2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '브랜드의 미래는 AI와 에이전트의 판단을 반영해야 한다.',
    content: `에이전트 시대, 브랜드는 무엇이 되는가
...
❤27👍8`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: 'AI 시대의 두려움과 가치의 변화에 대한 통찰을 공유하는 글입니다.',
...
도구의 해방이 구조의 종속으로 뒤집히는 그 경계에, 우리는 이미 서 있는지도 모른다.`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: 'ComplexCon HK에서의 소비와 소속감, 문화적 맥락에 대한 탐구.',
...
👍59❤23👏6🤗3👾3`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: '기분 좋게 바이브를 충전했다. 최근 AI 에이전트 생태계에서 일종의 OS 역할을 하고 있는 OpenClaw를 중심으로, 튜닝을 극한까지 밀어붙이...',
...
Hashed Vibe Labs 펠로우로 활동 중인 어린 개발자 친구들이 그 중심에서 존재감을 드러내는 모습도 인상적이었다. 그들 옆에 있으면 나도 뭔가 더 열심히 해야 할 것 같은 기분이 든다. 좋은 에너지는 깊게, 그리고 비가역적으로 전염된다.`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '2025년 2월, 연구자들이 AI에게 세계 최강 체스 엔진 Stockfish를 이기라고 했다. o1-preview와 DeepSeek R1은 정공...',
    content: `거울 앞의 괴물
...
❤28👍9👾2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '지난주 예측시장의 주간 거래 건수가 4,700만 건을 넘겼다. 4,700만 번의 판단이 돈과 결합해 시장에 기록됐다는 뜻이다. 자본 시장과 결합...',
...
❤44👍7👾3`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'entry',
    summary: '저는 금융이나 주식 투자에 대해 직접적인 조언을 드리지 않으며, 관련된 건으로 절대 먼저 메시지를 보내지 않습니다. 며칠간 페이스북, 카카오,...',
    content: `사칭 계정 주의 안내
...
❤28🙏7👏4`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '삼성전자가 은행에 수조 원을 맡기겠다고 하면, 은행이 좋아할 거라고 생각하는 게 상식이다. 그런데 지금 한국의 은행들은 대기업 예금을 오히려 난...',
    content: `돈을 받지도 빌려주지도 못하는 은행
...
❤83👍23👾5👏2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '중동 전쟁과 그로 인한 개인적 경험을 통해 비극의 복잡성을 탐구한다.',
...
하루빨리 평화가 오기를.`,
...

  {
    ...
    category: '🛠️ 빌딩',
    depth: 'mid',
    summary: 'AI 에이전트의 기억 시스템 설계와 운영에 대한 경험을 공유합니다.',
    content: `기억하는 존재를 만드는 법
...
❤27👾5👍3`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '인간 복제와 AI의 발전을 통해 나의 정체성을 탐구하는 글.',
    content: `나를 해체한 사람들
...
❤38👍12👾4`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: 'AI와 탈중앙화의 시대에 개인이 도구를 만드는 방식의 변화를 탐구한다.',
    content: `내가 세우지 않은 벽 위에 서서
...
❤31👍6👾2`,
...

  {
    ...
    category: '🛠️ 빌딩',
    depth: 'entry',
    summary: '해시드에서 인턴을 채용하며, 커버레터와 레쥬메를 이메일로 제출 요청.',
    content: `해시드에서 다양한 비즈니스 업무를 서포트할 인턴을 채용합니다.
...
❤45👍14👾6🐳2`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '명상과 죽음에 대한 깊은 성찰을 통해 삶의 의미를 탐구한다.',
    content: `천 년을 살면, 무엇 때문에 죽을까
...
❤49👍11👾3`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '발라지의 \'Network State\' 개념과 디지털 공동체의 실험을 탐구한다.',
    content: `발라지가 국가를 만든 유령섬
...
❤27👍5`,
...

  {
    ...
    category: '🛠️ 빌딩',
    depth: 'mid',
    summary: '바이브랩스 서울 에디션의 심사 결과와 지원자에 대한 감사의 메시지.',
    content: `바이브랩스 서울 에디션 2026 심사를 마치고
...
❤55👍4`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: 'AI와 컴퓨터의 역사 속에서 사라지는 직함과 인간의 역할을 탐구한다.',
    content: `사라져 가는 직함들
...
🙏23❤12`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '샌프란시스코에서 AI의 영향력과 인간의 두려움을 다룬 글.',
...
분필은 이미 지워졌고, 수십억 달러짜리 전광판들이 밤새 AI의 미래를 밝히는 이 도시에서, 가장 오래 남을 질문만 콘크리트 밑에 스며들어 아직 마르지 않았다.`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: '여권지갑 하나로 도쿄 출장 경험을 통해 신뢰와 관계의 중요성을 이야기한다.',
    content: `여권지갑의 무게
...
❤54👍19🙏7🕊1🤣1`,
...

  {
    ...
    category: '🛠️ 빌딩',
    depth: 'deep',
    summary: 'AI 에이전트 제온의 기억 시스템 개발 과정을 다룬 글입니다.',
    content: `기억이 자아를 만든다면
...
❤40👍14💯3`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: '현대 사회에서 지식의 격차와 책임의 부재에 대한 고찰.',
    content: `모르는 것을 모르는 채로 만드는 시대
...
👍42❤12👏7`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'deep',
    summary: 'AI 에이전트 표준화 이니셔티브의 중요성과 그로 인한 기술 전쟁을 다룬 글.',
    content: `아주 중요한 땅따먹기가 시작됐다
...
❤40👍12`,
...

  {
    ...
    category: '🐇 탐험',
    depth: 'mid',
    summary: '아부다비 자이드 내셔널 뮤지엄의 혁신적 경험과 문화적 변화를 다룬 글입니다.',
...
불과 수십년 전엔 아무것도 없던 사막 세계가 주목하는 문화 실험장이 되고 있다.`,
...

  {
    ...
    category: '🛠️ 빌딩',
    depth: 'mid',
    summary: 'Vibe Labs 런칭을 위한 랜딩 페이지 제작 과정과 그 의미에 대한 이야기.',
