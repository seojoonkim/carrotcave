...
test('archive cards use one standard format for posts and voices at every breakpoint', async () => {
  ...
  assert.match(css, /@media\(min-width:901px\)\{\.axis-rail a\{border-right:0;gap:7px\}\.axis-rail b\{font-size:13px\}\.axis-rail span\{font-size:7\.3px\}\.axis-rail a:is\(:hover,:focus-visible,\.active\) b\{font-size:13px;transform:none\}\.axis-rail a:is\(:hover,:focus-visible,\.active\) span\{font-size:7\.3px\}\.editorial-wall \.wall-card h2\{font-size:19\.2667px\}\}/);
