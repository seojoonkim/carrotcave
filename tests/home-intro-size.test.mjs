...
test('only the default home archive introduction is two pixels smaller', async () => {
  ...
  assert.match(css, /\.wall-heading__home-title\{display:block;font-size:calc\(1em - 2px\)\}/);
