...
일본에서는 개발자를 포함한 IT 인력의 72퍼센트가 IT 기업, 즉 벤더 쪽에 속하고 사업회사에는 28퍼센트만 있다. 한국과 미국, 영국, 독일, 프랑스, 캐나다를 비롯한 대다수 선진국에서는 반대로 IT 인력의 과반이 사업회사에서 일한다. 일본 기업 안에는 시스템을 주문하고 검수하는 사람은 많지만, 고객 반응을 보고 다음 버전을 직접 만드는 사람은 상대적으로 적은 것이다.
