...
export interface OntologyEdge { from:string; to:string; type:RelationType; strength:number; sourceClaimId:string; sourceEvidence:string; targetEvidence:string; label:string; source:string; signals:string[]; status:ReviewStatus }
...
export interface SubgraphNode extends OntologyNode { hop:0|1|2; via?:string }
